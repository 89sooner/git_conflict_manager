...
| T-017 | 6 | 06_pr_core_features | PR risk/review read model을 실제 DB/worker 파이프라인에 연결 | unassigned | todo | 현재 Phase 6 구현은 seeded fixture 기반. `apps/worker` job + DB query layer로 교체하고 migration 0002 테이블과 실제 동기화를 연결해야 함 |
